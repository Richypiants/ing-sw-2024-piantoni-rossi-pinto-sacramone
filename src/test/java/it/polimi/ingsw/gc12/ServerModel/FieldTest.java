...
class FieldTest {
    ...
    @Test
    void cardUndefinedNotAdded() {  // addCard()
        ...
        assertFalse(p1_g.placeCard(new GenericPair<>(1, -1), null, Side.FRONT));
    ...
    void getCardCoordinates() {
        ...
        p1_g.addCardToHand(c0);
        p1_g.placeCard(new GenericPair<>(0, 0), c0, Side.FRONT);
        GenericPair<Integer, Integer> coord_res = new GenericPair<>(p1_g.getCardCoordinates(c0).getX(), p1_g.getCardCoordinates(c0).getX());
        assertEquals(new GenericPair<>(0, 0), coord_res);
