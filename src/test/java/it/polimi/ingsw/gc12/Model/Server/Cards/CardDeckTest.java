...
import it.polimi.ingsw.gc12.Utilities.JSONParsers.Server.ServerJSONParser;
...
public class CardDeckTest {
    ...
    public final static String RESOURCE_DECK_FILENAME = "/jsonFiles/Server/resource_cards.json";
    public final static String GOLD_DECK_FILENAME = "/jsonFiles/Server/gold_cards.json";
    public final static String INITIAL_DECK_FILENAME = "/jsonFiles/Server/initial_cards.json";
    public final static String OBJECTIVE_DECK_FILENAME = "/jsonFiles/Server/objective_cards.json";
