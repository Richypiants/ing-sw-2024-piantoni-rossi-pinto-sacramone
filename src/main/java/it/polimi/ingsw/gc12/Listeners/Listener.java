 ...
 * <p>
 * The {@code Listener} class represents an entity responsible for handling notifications sent by the server to clients.
...
public class Listener {
    ...
    /**
     * The NetworkSession associated to this listener.
     */
