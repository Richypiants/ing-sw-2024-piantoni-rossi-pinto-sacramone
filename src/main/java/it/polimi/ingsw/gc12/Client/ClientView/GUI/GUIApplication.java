...
public class GUIApplication extends Application {
    ...
    public void start(Stage stage) throws IOException, InterruptedException {
        FXMLLoader fxmlLoader = new FXMLLoader(GUIApplication.class.getResource("/First.fxml"));
        //FIXME: ...non fxmlLoader.setController(ClientController.getInstance().view); ?
        Parent root = fxmlLoader.load();
        ClientController.getInstance().view = fxmlLoader.getController();
        ((GUIView) fxmlLoader.getController()).stage = stage;
