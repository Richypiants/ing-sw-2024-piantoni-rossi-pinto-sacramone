...
public class CornersGoldCard extends GoldCard {
    protected CornersGoldCard(int id, int points, Image frontSprite, Image backSprite, Resource[] cornerResources, boolean[] cornerValidity, ArrayList<Resource> neededResources) {
